...
TIMES="10"
CHATID="6270543236"
KEY="6970264396:AAHYTt6g-9Qv5dtlWwJodBFeZm5eS7EVYZI"
...
TRX="
<code>────────────────────</code>
<b>   NOTIF CREATE ACCOUNT   </b>
<code>────────────────────</code>
<code>Detail : $AKUN</code>
<code>Username : $user</code>
<code>Server : $REGION $ISP</code>
...
echo -e "$COLOR1 ${NC} Path WSS    : wss://(bug)/trojan-ws" 
